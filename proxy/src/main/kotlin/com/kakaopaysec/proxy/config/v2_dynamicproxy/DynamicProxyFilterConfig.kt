...
import com.kakaopaysec.proxy.config.v2_dynamicproxy.handler.LogTraceFilterHandler
import com.kakaopaysec.proxy.log.trace.logtrace.LogTrace
import org.springframework.context.annotation.Bean
import org.springframework.context.annotation.Configuration
import java.lang.reflect.Proxy

private val patterns = arrayOf("save*", "order*", "request*")
...
class DynamicProxyFilterConfig {
    ...
    fun orderApiV1(trace: LogTrace): OrderApiV1 {
        ...
        val proxy = Proxy.newProxyInstance(
            ...
            LogTraceFilterHandler(orderApiV1, trace, patterns)
        )
    ...
    fun orderServiceV1(trace: LogTrace): OrderServiceV1 {
        ...
        val proxy = Proxy.newProxyInstance(
            ...
            LogTraceFilterHandler(orderServiceV1, trace, patterns)
        )
    ...
    fun orderRepositoryV1(trace: LogTrace): OrderRepositoryV1 {
        ...
        val proxy = Proxy.newProxyInstance(
            ...
            LogTraceFilterHandler(orderRepositoryV1, trace, patterns)
        )
